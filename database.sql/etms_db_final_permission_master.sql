...
CREATE TABLE `permission_master` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UKqkgig4kmoog8u4qkmtth9wmgf` (`permission_name`)
...
INSERT INTO `permission_master` VALUES (5,'MANAGE_ATTENDANCE'),(3,'MANAGE_BATCHES'),(2,'MANAGE_COURSES'),(1,'MANAGE_USERS'),(4,'VIEW_REPORTS'),(6,'VIEW_STUDENTS');
