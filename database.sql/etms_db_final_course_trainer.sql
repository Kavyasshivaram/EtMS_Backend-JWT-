...
CREATE TABLE `course_trainer` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKo8hb0urori6uo17weh2hfurpu` (`course_id`),
  KEY `FKcskkakr1txtlpmeupsmafprf1` (`trainer_id`),
  CONSTRAINT `FKcskkakr1txtlpmeupsmafprf1` FOREIGN KEY (`trainer_id`) REFERENCES `users` (`id`),
  CONSTRAINT `FKo8hb0urori6uo17weh2hfurpu` FOREIGN KEY (`course_id`) REFERENCES `course_master` (`id`)
...
-- Dump completed on 2026-03-21 17:57:06
